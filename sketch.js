...
function setup() {
  ...
  block8 = new PinkBox(330+60,235,30,40);
  block9 = new PinkBox(360+60,235,30,40);
  block10 = new PinkBox(390+60,235,30,40);
  block11 = new PinkBox(420+60,235,30,40);
  block12 = new PinkBox(450+60,235,30,40);


  block13 = new GreenBox(360+60,195,30,40);
  block14 = new GreenBox(390+60,195,30,40);
  block15 = new GreenBox(420+60,195,30,40);
  ...
  block22 = new GreenBox(800-30,205-40,30,40);
  block23 = new GreenBox(800,205-40,30,40);
  block24 = new GreenBox(800+30,205-40,30,40);
  ...
  sling = new SlingShot(polygon.body,{x:180,y:190})
}
